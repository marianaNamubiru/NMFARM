...
public class AddFeedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText et_desc = findViewById(R.id.editTextDesc);
    ...
    private void postFeed(final String title, final String desc) {
        ...
        Call<ErrorMsgResponse> call = apiService.addFeed(params);
